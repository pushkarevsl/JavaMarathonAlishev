 ...
 * метод evaluate (оценить студента), принимающий в качестве аргумента студента, и работающий следующим образом:
...
public class Task3 {
    ...
    public static void main(String[] args) {
        Teacher teacher = new Teacher("Мария Петровна", "литература");

        Student student = new Student("Васильев");
